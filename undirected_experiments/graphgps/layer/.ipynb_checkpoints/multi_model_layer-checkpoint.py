...
from graphgps.layer.unitary_conv_layer_enhanced import EDUnitaryGCNConvLayer
...
class LocalModel(nn.Module):
    def __init__(self, dim_h, local_gnn_type, edge_type, edge_attr_type, num_heads,
        ...
        elif local_gnn_type == "UnitaryGCNEnhanced":
            self.local_model = EDUnitaryGCNConvLayer(dim_h, dim_h)
    ...
    def forward(self, batch):
        ...
        if self.local_gnn_type == 'CustomGatedGCN':
            ...
            elif self.local_gnn_type == "UnitaryGCNEnhanced":
                        h_local = self.local_model(batch).x.real
            elif self.local_gnn_type == "OrthogonalGCN":
        ...
        for layer_type in model_types:
            ...
            if layer_type in {'Transformer', 'ETransformer', 'Exphormer', 'Performer', 'BigBird'}:
                self.models.append(GlobalModel(dim_h=dim_h,
                               ...
                               "OrthogonalGCN", "UnitaryGCNEnhanced"}:
